...
namespace JB
{
    public class DlApps
    {
        ...
        public DataSet GetApplication(int applicationname,int lowlimit, int highlimit)
        {
            var Ds = new DataSet();
            ...
            var myda =
                new MySqlDataAdapter(
                    ...
                    applicationname + " limit "+lowlimit+","+highlimit+";", mycon);
        ...
        public int GetApplicationcount(int applicationname)
        {
            //store rec details
            var connreader = new MySqlConnection { ConnectionString = Dlconnect.Makeconn() };
            ...
            using (connreader)
            {
                var command = new MySqlCommand(@"select count(idapplications) from getapp where empid=" +
                    applicationname+";", connreader);
                connreader.Open();
