...
namespace JB
{
    public class DlMainpagepopulator
    {
        ...
        public DataSet GetSalary()
        {
            ...
            var myda =
                new MySqlDataAdapter(@"select termid, sTerm from terms where termid >= 6000 and termid <7000 order by termid;", mycon);
        ...
        public DataSet GetrecArchive(int sEmpID, int lowlimit, int highlimit)
        {
            var ds = new DataSet();
            ...
            var myda = new MySqlDataAdapter(@"select * from getjobssingle where EmployeeID = '" + sEmpID + "' limit "
                 + lowlimit + "," + highlimit + ";"
        ...
        public int GetrecArchivecount(int sEmpID)
        {
            var arrayrec = string.Empty;
            var connreader = new MySqlConnection { ConnectionString = Dlconnect.Makeconn() };
            ...
            using (connreader)
            {
                var command = new MySqlCommand(@"select count(*) from getjobssingle where EmployeeID = '" + sEmpID + "' ;"
        ...
        public DataSet GetrecActive(int sEmpID, int lowlimit, int highlimit)
        {
            var ds = new DataSet();
            ...
            var myda = new MySqlDataAdapter(@"select * from getjobssinglearch where EmployeeID = '" + sEmpID + "' limit "
                +lowlimit+","+highlimit+";"
                ,
                                            mycon);
        ...
        //get recruiter inactiv job count
        public int GetrecActivecount(int sEmpID)
        {
            var arrayrec = string.Empty;
            var connreader = new MySqlConnection { ConnectionString = Dlconnect.Makeconn() };
            ...
            using (connreader)
            {
                var command = new MySqlCommand(@"select count(*) from getjobssinglearch where EmployeeID = '" + sEmpID + "' ;"
        ...
        public DataSet Getmyapps(string uusername, int lowlimit, int highlimit)
        {
            var ds = new DataSet();
            ...
            var myda = new MySqlDataAdapter(@"select * from getmyapps where uusername='" + uusername + "' limit "+lowlimit+","+highlimit+";", mycon);
        ...
        public int Getmyappscount(string uusername)
        {
            ...
            using (connreader)
            {
                var command = new MySqlCommand(@"select count(*) from getmyapps where uusername='" + uusername + "';", connreader);
                connreader.Open();
