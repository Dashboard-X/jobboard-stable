    ...
    public partial class Default : Clpager
    {
        ...
        private void SetSearch()
        {
            ...
            if (Request.QueryString["q"] != null)
            {
                ...
                {
                    GridView1.DataSource = _sr.GetJobssingle(lowlimit, pagesize);
                    GridView1.DataBind();
                ...
                else if (Request.QueryString["filter"] != null)
                {
                    ...
                    GridView1.DataSource = _cr.Applytitlefilter(_title, _criteria, lowlimit, pagesize);
                    GridView1.DataBind();

                    //get total jobs
                    maxpages = _cr.Applytitlefiltercount(_title, _criteria, lowlimit, pagesize);
                ...
                else
                {
                    ...
                    GridView1.DataSource = _cr.Applytitlefilter(__title, lowlimit, pagesize);
                    GridView1.DataBind();

                    //get total jobs
                    maxpages = _cr.Applytitlefiltercount(__title, lowlimit, pagesize);
            ...
            else
            {
                ...
                else
                {
                    ...
                    GridView1.DataSource = _cr.Applycriteriafilter(_criteria, lowlimit, pagesize);
                    GridView1.DataBind();

                    //get total jobs
                    maxpages = _cr.Applycriteriafiltercount(_criteria, lowlimit, pagesize);
            ...
            DlRecruiter rec= new DlRecruiter();
