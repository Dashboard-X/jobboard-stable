    ...
    public partial class RecJobs : Clcookiehandler
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["jobid"] != null)
                {
                    ...
                    //get recid
                    string recid = mp.RecName(Session["pusername"].ToString());
                    ...
                    foreach (int arritem in from int __arritem in __al select Convert.ToInt32(__arritem))
                    {
                        if (arritem >= 5000 && arritem < 6000)
                        {
                            //industry
                            CheckBoxList1.Items.FindByValue(arritem.ToString(CultureInfo.InvariantCulture)).Selected =
                                true;
                        }
                        ...
                        {
                            //locations
                            CheckBoxList2.Items.FindByValue(arritem.ToString(CultureInfo.InvariantCulture)).Selected =
                                true;
                        }
                        ...
                        {
                            //contract
                            CheckBoxList3.Items.FindByValue(arritem.ToString(CultureInfo.InvariantCulture)).Selected =
                                true;
                        }
                        ...
                        {
                            //salary
                            CheckBoxList6.Items.FindByValue(arritem.ToString(CultureInfo.InvariantCulture)).Selected =
                                true;
                        }
                        ...
                        {
                            //hours
                            CheckBoxList7.Items.FindByValue(arritem.ToString(CultureInfo.InvariantCulture)).Selected =
                                true;
                        }
                        ...
                        {
                            //employement type
                            CheckBoxList8.Items.FindByValue(arritem.ToString(CultureInfo.InvariantCulture)).Selected =
                                true;
                        }
                    }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["jobid"] != null)
            {
                ...
                string recid = mpage.RecName(Session["pusername"].ToString());
                ...
                //industry
                foreach (
                    ListItem listitems3 in CheckBoxList1.Items.Cast<ListItem>().Where(listitems3 => listitems3.Selected)
                    )
                {
                ...
                //insert contract
                foreach (
                    ListItem listitems2 in CheckBoxList3.Items.Cast<ListItem>().Where(listitems2 => listitems2.Selected)
                    )
                {
                    //insert cats
                ...
                //insert hours
                foreach (
                    ListItem listitems4 in CheckBoxList7.Items.Cast<ListItem>().Where(listitems4 => listitems4.Selected)
                    )
                {
                ...
                foreach (
                    ListItem listitems5 in CheckBoxList8.Items.Cast<ListItem>().Where(listitems5 => listitems5.Selected)
                    )
                {
                ...
                //insert salary
                foreach (
                    ListItem listitems6 in CheckBoxList6.Items.Cast<ListItem>().Where(listitems6 => listitems6.Selected)
                    )
                {
            ...
            else
            {
                ...
                var mpage = new DlMainpagepopulator();
                string recid = mpage.RecName(Session["pusername"].ToString());
                string mxjobsid = __guid.GenerateGuid();
