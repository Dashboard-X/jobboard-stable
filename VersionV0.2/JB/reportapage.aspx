<%@ Page Title="" Language="C#" MasterPageFile="~/Job.Master" AutoEventWireup="true" CodeBehind="reportapage.aspx.cs" Inherits="JB.reportapage" %>
...
<div class="simpleboxdetail">
    ...
    <br />
<br />
    <asp:TextBox ID="spamreasons" runat="server" CssClass="TextboxSt" Width="310px"></asp:TextBox><br /><br />
    <asp:Button ID="Button1" runat="server" CssClass="button" Text="Report" 
