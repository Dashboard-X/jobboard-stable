...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <img alt="" src="../images/nm_one.png" />&nbsp;<asp:Label ID="Label11" runat="server" CssClass="simplefontblack" Text="Register to receive jobs by email!"
            Width="200px"></asp:Label>
        <asp:Button ID="Button2" runat="server" CssClass="button" Text="Register   " 
            OnClick="Button2_Click" />
    </div>
    <br />
    <div>
        <img alt="" src="../images/nm_two.png" />&nbsp;<asp:Label ID="Label12" runat="server" CssClass="simplefontblack" Text="Continue without registration"
            Width="200px"></asp:Label>
