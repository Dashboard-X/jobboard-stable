...
<asp:Label ID="Label1" runat="server" CssClass="StyleR1" Text="Applications made"></asp:Label>
</div>
...
<div class="jseekermidback">
 <!-- hook up ajax-->
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="StyleR1"
