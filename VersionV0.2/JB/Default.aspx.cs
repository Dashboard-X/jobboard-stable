...
namespace JB
{
    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            ////get client ip
            //string csip = Request.ServerVariables["REMOTE_ADDR"].ToString();

            ////add comment to db here
            //CLMainpagepopulator cmppgpop = new CLMainpagepopulator();
            //cmppgpop.insertsitecomment(TextBox3.Text, TextBox4.Text, csip);
