        ...
        <div id="setbox">
            ...
            <div id="dvleftpanels1">
                ...
                <div id="dvltindustry" class="divchkbxpop">
                    <asp:CheckBoxList ID="CheckBoxList1" runat="server" CssClass="simplefontblack">
                ...
                <div id="dvltlocation" class="divchkbxpop">
                    <asp:CheckBoxList ID="CheckBoxList2" runat="server" CssClass="simplefontblack">
            ...
            <div id="dvleftpanels2">
                ...
                <div id="dvltsalary" class="divchkbxpop">
                    <asp:CheckBoxList ID="CheckBoxList6" runat="server" CssClass="simplefontblack">
                ...
                <div id="dvltcontract" class="divchkbxpop">
                    <asp:CheckBoxList ID="CheckBoxList3" runat="server" CssClass="simplefontblack">
            ...
            <div id="dvleftpanels3">
                ...
                <div id="dvlthours" class="divchkbxpop">
                    <asp:CheckBoxList ID="CheckBoxList4" runat="server" CssClass="simplefontblack">
                ...
                <div id="dvltemployer" class="divchkbxpop">
                    <asp:CheckBoxList ID="CheckBoxList5" runat="server" CssClass="simplefontblack">
