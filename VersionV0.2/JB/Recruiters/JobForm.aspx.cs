...
namespace JB.Recruiters
{
    ...
    public partial class RecJobs : System.Web.UI.Page
    {
        ...
        //typesafe function
        public string typesaveme(string texttosave)
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    int sjobids = Convert.ToInt16(Request.QueryString["jobid"]);

                    /*set locations*/
                    int[] arr = new int[250];
                    arr = cljbs.getmutitexts(sjobids);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string edate = enddate.ToString("MM/dd/yyyy");
                ...
                if (Request.QueryString["jobid"] != null)
                {
                    ...
                    //update job
                    mpage.updatejobs(mxjobsid, TextBox1.Text, TextBox2.Text, Editor1.Content, TextBox5.Text, 0, 0, TextBox6.Text, sdate, edate);
                ...
                else
                {
                    ...
                    mpage.insertjobs(mxjobsid, TextBox1.Text, TextBox2.Text , Editor1.Content  ,  TextBox5.Text , 0, 0, TextBox6.Text, sdate ,edate);
