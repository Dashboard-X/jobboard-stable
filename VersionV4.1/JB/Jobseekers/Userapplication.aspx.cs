        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["CRF"] == "1")
            {
                if (clog.Checkcanusern(TextBox11.Text) != TextBox11.Text)
                {
                    ...
                    string mxuserid = phash.GenerateGuid();
                    string mxcandidateid = phash.GenerateGuid();
                    ...
                    string makehashp =
                        phash.GetMd5Hash(rands1.Next(10000, 100000).ToString(CultureInfo.InvariantCulture));
                    ...
                    string emailbod =
                        emproc.Emailactivateusr(
                            "https://ahrcloud.com.com/ActivateAccount.aspx?activationid=" + makehashp +
                    ...
                    emproc.Sendappemaildbupdate(phash.GenerateGuid() , TextBox11.Text, 2);
