        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="400px"
                              ShowHeader="False" BorderWidth="0px" AllowPaging="False" GridLines="None" OnRowDataBound="GridView1_RowDataBound">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("sTitle") %>' CssClass="ux_StyleBlackbold"></asp:Label>
                                <br />
                                ...
                                <asp:HyperLink ID="HyperLink7" runat="server" CssClass="ux_Stylea8" NavigateUrl='<%# "JobForm.aspx?Fg=1&JobID=" + Eval("idJobs") + "&rand=" + Request.QueryString["rand"] %>'>Edit...</asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
